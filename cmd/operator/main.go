...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "bbc81c8d.se.quencer.io",
	...
	if err = (&controller.ComponentReconciler{
		Client:        mgr.GetClient(),
		Scheme:        mgr.GetScheme(),
		EventRecorder: mgr.GetEventRecorderFor("component"),
	}).SetupWithManager(mgr); err != nil {
	...
	if value, _ := env.GetBool("DISABLE_WEBHOOKS", false); !value {
		if err = (&sequencer.Build{}).SetupWebhookWithManager(mgr); err != nil {
